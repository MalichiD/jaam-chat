...
import { Edit, Hash, Mic, Lock, Trash2, Video } from "lucide-react";
...
export const ServerChannel = ({
    ...
    return (
        ...
        params?.channelId === channel.id && "text-primary dark:text-zinc-200 bg-zinc-700/10 dark:bg-zinc-700")}>
            ...
            {channel.name !== "general" && role !== MemberRole.GUEST && (
                    <div className="ml-auto flex items-center gap-x-2">
                        ...
                        <ActionTooltip label="Delete">
                            ...
                            className="hidden group-hover:block w-4 h-4 text-zinc-500 hover:text-rose-500 dark:text-zinc-400
